...
public class PayloadJsonTest {
    ...
    public void assetBalance() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.wallet.v2.data.model.remote.response.AssetBalance ab = gson.fromJson(
                abJson, com.wavesplatform.wallet.v2.data.model.remote.response.AssetBalance.class);
    ...
    public void assetBalances() {
        ...
        Gson gson = new Gson();
        com.wavesplatform.wallet.v2.data.model.remote.response.AssetBalances abs = gson.fromJson(
                abJson, com.wavesplatform.wallet.v2.data.model.remote.response.AssetBalances.class);
